...
struct std::_Is_checked_helper<boost::multi_index::safe_mode::safe_iterator<_Container, _Value> >
	: public true_type
{   // mark boost::multi_index::safe_mode::safe_iterator as checked. This supresses warning C4996
};
#endif
